...
set_input_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {dbg_disable_arc}]
set_input_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {dbg_disable_ctc}]
set_input_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {dbg_disable_rom}]
...
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {bcd_oen}]
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {carry_bus}]
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {carry_oen}]
...
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {ia_oen}]
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {is_bus}]
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {is_oen}]
...
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {phi_oen}]
...
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {sync_oen}]
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {ws_bus}]
set_output_delay 2.0000 -clock [get_clocks {osc_in}] -add_delay [get_ports {ws_oen}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0334 [get_ports {START}]
set_load -pin_load 0.0334 [get_ports {bcd_bus}]
set_load -pin_load 0.0334 [get_ports {bcd_oen}]
set_load -pin_load 0.0334 [get_ports {carry_bus}]
set_load -pin_load 0.0334 [get_ports {carry_oen}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {dbg_disable_arc}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {dbg_disable_ctc}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {dbg_disable_rom}]
